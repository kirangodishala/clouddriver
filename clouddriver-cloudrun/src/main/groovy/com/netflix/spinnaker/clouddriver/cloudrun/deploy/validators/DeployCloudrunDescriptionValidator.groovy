...
class DeployCloudrunDescriptionValidator extends DescriptionValidator<DeployCloudrunDescription> {
  @Autowired
  CredentialsRepository<CloudrunNamedAccountCredentials> credentialsRepository

  @Override
  void validate(List priorDescriptions, DeployCloudrunDescription description, ValidationErrors errors) {
    def helper = new StandardCloudrunAttributeValidator("deployCloudrunAtomicOperationDescription", errors)
