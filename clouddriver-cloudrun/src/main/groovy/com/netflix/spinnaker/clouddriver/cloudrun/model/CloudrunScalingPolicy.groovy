...
class CloudrunScalingPolicy implements Serializable {
  ...
  CloudrunScalingPolicy() {
    type = ScalingPolicyType.AUTOMATIC
  }

  CloudrunScalingPolicy(AutomaticScaling automaticScaling) {
    type = ScalingPolicyType.AUTOMATIC
