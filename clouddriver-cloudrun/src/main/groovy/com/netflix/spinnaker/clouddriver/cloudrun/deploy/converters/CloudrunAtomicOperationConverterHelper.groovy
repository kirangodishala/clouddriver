...
class CloudrunAtomicOperationConverterHelper {
  static <T extends AbstractCloudrunCredentialsDescription> T convertDescription(Map input,
                                                                                 AbstractAtomicOperationsCredentialsConverter<CloudrunNamedAccountCredentials> credentialsSupport,
    ...
    converted.credentials = credentials as CloudrunNamedAccountCredentials
    converted
  }
}
