...
class CloudrunInstance implements Instance, Serializable {
  String name
  String id
  Long launchTime
  ...
  final String providerType = CloudrunCloudProvider.ID
  ...
  List<Map<String, Object>> health
    ...
    CloudrunInstance(AppengineApiInstance instance, Version version, Service service, String region) {
    this.health = [new CloudrunHealth(version, service).toMap()]
