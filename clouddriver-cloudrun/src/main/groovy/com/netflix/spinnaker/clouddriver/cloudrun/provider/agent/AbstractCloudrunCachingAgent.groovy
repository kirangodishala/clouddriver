...
abstract class AbstractCloudrunCachingAgent implements CachingAgent, AccountAware, AgentIntervalAware {
  final String accountName
  final String providerName = CloudrunProvider.PROVIDER_NAME
  final CloudrunCloudProvider cloudrunCloudProvider = new CloudrunCloudProvider()
  final ObjectMapper objectMapper
  final CloudrunNamedAccountCredentials credentials

  AbstractCloudrunCachingAgent(String accountName,
