...
package com.netflix.spinnaker.clouddriver.cloudrun.gcsClient


import com.netflix.spinnaker.clouddriver.cloudrun.CloudrunJobExecutor
import com.netflix.spinnaker.clouddriver.cloudrun.artifacts.ArtifactUtils
...
@Slf4j
@TupleConstructor
class CloudrunGcsRepositoryClient implements CloudrunRepositoryClient {
