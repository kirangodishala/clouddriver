...
class CloudrunConfiguration {
  ...
  @Bean
  CloudrunHealthIndicator cloudrunHealthIndicator() {
    new CloudrunHealthIndicator()
  }

  @Bean
  CloudrunProvider cloudrunProvider(CloudrunCloudProvider cloudProvider) {
    new CloudrunProvider(cloudProvider)
  }
